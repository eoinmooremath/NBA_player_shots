...
st.markdown(
    ...
    <style>
    /* -------------------------
       GLOBAL: eliminate tiny scrollbars
       ------------------------- */
    * {{ box-sizing: border-box; }}
    ...
    .stApp {{
        ...
        color: #ffffff;
        height: 100vh;
        overflow: hidden; /* kill app scroll */
    }}

    /* Main area: prevent the little extra scroll */
    ...
    /* -------------------------
       SIDEBAR: eliminate sidebar scroll while keeping footer pinned
       ------------------------- */
    ...
    /* Sidebar internal wrappers that commonly scroll */
    ...
    [data-testid="stSidebarContent"] {{
        height: 100vh !important;
        overflow: hidden !important;     /* kills sidebar scroll */
        display: flex !important;        /* enable footer pinning via flex */
        flex-direction: column !important;
        padding-bottom: 12px !important; /* breathing room without forcing overflow */
    }}

    /* This is the vertical stack of widgets inside the sidebar */
    [data-testid="stSidebar"] [data-testid="stVerticalBlock"] {{
        flex: 1 1 auto !important;
        min-height: 0 !important;        /* IMPORTANT: lets flex children shrink instead of overflowing */
        display: flex !important;
        flex-direction: column !important;
        overflow: hidden !important;      /* prevents the “medium scroll” */
    }}

    /* Push the LAST widget (your How to use block) to the bottom */
    ...
    /* Safety net: if it *does* get collapsed (browser remembered state), keep expand visible */
